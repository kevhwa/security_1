...
#
openssl genrsa -aes256 -passout pass:pass -out $HOMEROOT/private/ca1.key.pem 4096

chmod 400 $HOMEROOT/private/ca1.key.pem

openssl req -config $HOMEROOT/root_openssl.cnf -subj '/C=US/ST=New York/O=COMS4181 Hw2/CN=rootCA1' -passin pass:pass -key $HOMEROOT/private/ca1.key.pem -new -x509 -days 7300 -sha256 -extensions v3_ca -out $HOMEROOT/certs/ca1.cert.pem 

chmod 444 $HOMEROOT/certs/ca1.cert.pem
...
openssl ca -config $HOMEINTER/inter_openssl.cnf -passin pass:pass -startdate 201010231800Z -enddate 201010231800Z -extensions usr_cert -notext -md sha256 -in $HOMEINTER/csr/www.example_client2.com.csr.pem -out $HOMEINTER/certs/www.example_client2.com.cert.pem -batch
...
# Create a key pair for the client
openssl genrsa -aes256 -passout pass:pass -out $HOMEINTER/private/www.example_client6.com.key.pem 2048

chmod 400 $HOMEINTER/private/www.example_client6.com.key.pem

# Create a CSR for client
openssl req -config $HOMEINTER/inter_openssl.cnf -subj '/C=US/ST=New York/O=COMS4181 Hw2/CN=www.exampleclient6.com' -passin pass:pass -key $HOMEINTER/private/www.example_client6.com.key.pem -new -sha256 -out $HOMEINTER/csr/www.example_client6.com.csr.pem
